...
for(marker in marker.features){
  ...
  # Separate by age
  for(age.type in unique(marker.barplot.df$age)){
...
for(age.type in unique(marker.boxplot.df$age)){
  ...
  # Export the boxplot named by age
    export.age.boxplot <- TRUE
  if(export.age.boxplot == TRUE){
    ggsave(paste0(project.folder.path, "qc/marker_qc_plots/", marker, "boxplot_roi_", age.type, ".png"), roi.marker.boxplot, width = 12, height = 1)
  }
...
if(export.combined.boxplot == TRUE){
  ...
  ggsave(paste0(project.folder.path, "qc/marker_qc_plots/", marker, "boxplot_roi_combined.png"), roi.combined.marker.boxplot, width = 12, height = 1)
